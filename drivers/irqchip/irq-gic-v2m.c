		    ...
		    const unsigned long end)
{
	...
	return gicv2m_init_one(acpi_parent_domain, spi_start, nr_spis, &res,
			       (void *)(m->base_address));
}

static int gicv2m_get_acpi_domain_token(struct device *dev,
...
int __init gicv2m_acpi_init(struct irq_domain *parent)
{
	...
	if (acpi_num_msi == 0)
		...
		msi_register_token_provider(&gicv2m_get_acpi_domain_token);
